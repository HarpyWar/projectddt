...
/* zlib includes. */
/* #include <zlib.h> */ /* DDT edit */
/* #include <bzlib.h> */  /* DDT edit */
...
int32_t libmpq__decompress_zlib(uint8_t *in_buf, uint32_t in_size, uint8_t *out_buf, uint32_t out_size) {
	 ...
	 /* DDT edit */
	//printf(" libmpq__decompress_zlib called while function removed! \n");
	return 1;
...
int32_t libmpq__decompress_bzip2(uint8_t *in_buf, uint32_t in_size, uint8_t *out_buf, uint32_t out_size) {
	 ...
	 /* DDT edit */
	//printf(" libmpq__decompress_bzip2 called while function removed! \n");
	return 1;
